...
CLOCK_INTERRUPT_PIN = 15  # Adjust to your specific GPIO pin for SQW
LED_PIN = 25  # Adjust to your specific GPIO pin for the LED
...
def on_alarm(pin):
    ...
    if rtc.alarm(alarm=0):  # Check if Alarm 0 triggered
        ...
        now = rtc.datetime()
        next_alarm_time = add_minutes_to_time(now, 2)  # Add 10 minutes
